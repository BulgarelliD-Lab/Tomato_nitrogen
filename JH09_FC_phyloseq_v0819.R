...
#separate root and rhizosphere samples 
JH09_FC_alpha_rare_Observed_MT_soil_rhizo <- JH09_FC_alpha_rare_Observed_MT_soil [JH09_FC_alpha_rare_Observed_MT_soil$Microhabitat != "Roots",]
JH09_FC_alpha_rare_Observed_MT_soil_root <- JH09_FC_alpha_rare_Observed_MT_soil[JH09_FC_alpha_rare_Observed_MT_soil$Microhabitat != "Rhizosphere",]

#rhizosphere samples 
kruskal.test(Observed ~ Treatment, data = JH09_FC_alpha_rare_Observed_MT_soil_rhizo )
posthoc.kruskal.dunn.test (x=JH09_FC_alpha_rare_Observed_MT_soil_rhizo$Observed, g=JH09_FC_alpha_rare_Observed_MT_soil_rhizo$Treatment, p.adjust.method="BH")

#root samples
kruskal.test(Observed ~ Treatment, data = JH09_FC_alpha_rare_Observed_MT_soil_root )
posthoc.kruskal.dunn.test (x=JH09_FC_alpha_rare_Observed_MT_soil_root$Observed, g=JH09_FC_alpha_rare_Observed_MT_soil_root$Treatment, p.adjust.method="BH")
...
#separate root and rhizosphere samples 
JH09_FC_alpha_rare_Chao1_MT_soil_rhizo <- JH09_FC_alpha_rare_Chao1_MT_soil [JH09_FC_alpha_rare_Chao1_MT_soil$Microhabitat != "Roots",]
JH09_FC_alpha_rare_Chao1_MT_soil_root <- JH09_FC_alpha_rare_Chao1_MT_soil[JH09_FC_alpha_rare_Chao1_MT_soil$Microhabitat != "Rhizosphere",]

#rhizosphere samples
kruskal.test(Chao1 ~ Treatment, data = JH09_FC_alpha_rare_Chao1_MT_soil_rhizo )
posthoc.kruskal.dunn.test (x=JH09_FC_alpha_rare_Chao1_MT_soil_rhizo$Chao1, g=JH09_FC_alpha_rare_Chao1_MT_soil_rhizo$Treatment, p.adjust.method="BH")

#root samples 
kruskal.test(Chao1 ~ Treatment, data = JH09_FC_alpha_rare_Chao1_MT_soil_root )
posthoc.kruskal.dunn.test (x=JH09_FC_alpha_rare_Chao1_MT_soil_root$Chao1, g=JH09_FC_alpha_rare_Chao1_MT_soil_root$Treatment, p.adjust.method="BH")
...
#separate root and rhizosphere samples 
JH09_FC_alpha_rare_Shannon_MT_soil_rhizo <- JH09_FC_alpha_rare_Shannon_MT_soil [JH09_FC_alpha_rare_Shannon_MT_soil$Microhabitat != "Roots",]
JH09_FC_alpha_rare_Shannon_MT_soil_root <- JH09_FC_alpha_rare_Shannon_MT_soil[JH09_FC_alpha_rare_Shannon_MT_soil$Microhabitat != "Rhizosphere",]

#rhizosphere samples 
kruskal.test(Shannon ~ Treatment, data = JH09_FC_alpha_rare_Shannon_MT_soil_rhizo )
posthoc.kruskal.dunn.test (x=JH09_FC_alpha_rare_Shannon_MT_soil_rhizo$Shannon, g=JH09_FC_alpha_rare_Shannon_MT_soil_rhizo$Treatment, p.adjust.method="BH")

#root samples
kruskal.test(Shannon ~ Treatment, data = JH09_FC_alpha_rare_Shannon_MT_soil_root )
posthoc.kruskal.dunn.test (x=JH09_FC_alpha_rare_Shannon_MT_soil_root$Shannon, g=JH09_FC_alpha_rare_Shannon_MT_soil_root$Treatment, p.adjust.method="BH")
...
#remove nursery samples and repeat the calculation
JH09_FC_data_phyloseq_prop_3 <- subset_samples(JH09_FC_data_phyloseq_prop_2, Treatments != "nursery")
JH09_FC_data_phyloseq_prop_3
design_soil_grown_3 <- design[colnames(otu_table(JH09_FC_data_phyloseq_prop_3)), ]

#BC distance adonis
BC <- phyloseq::distance(JH09_FC_data_phyloseq_prop_2, "bray")
adonis(BC ~ Microhabitat * Timing, data= design_soil_grown, permutations = 5000)
...
#WU distance adonis
#remove the bulk soil to assess the sample type effect (i.e., comparing harvest root/rhizo versus nursery samples)
...
#remove nursery sample sample and test for microhabitat * treatment effect
#adonis calculation
WU <- phyloseq::distance(JH09_FC_data_phyloseq_prop_3, "unifrac", weighted= TRUE)
adonis(WU ~ Microhabitat * Treatments, data= design_soil_grown_3, permutations = 5000)
